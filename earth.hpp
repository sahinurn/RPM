...
class Earth : protected Pokemon{
    public:
        Earth(std::string l_pokemonName, int l_pokemonHP, int l_pokemonATK, int l_pokemonDEF, int l_pokemonSPD, std::string l_pokemonSpecATK, std::string l_pokemonSpecDEF)
        {
